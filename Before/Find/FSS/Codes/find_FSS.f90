...
do 
  ...
  !**************************
  if (numION .eq. 1) write(3,*) readstep, time, numION, new_nsp1,new_nsp2
  if (numION .ne. 1) write(3,*) readstep, time, numION, new_nsp1,new_nsp2, iiO_record(1:numION)
  write(3,*) iiO(1),iiH(1:numH,1)
  do p=1,new_nsp1
    write(3,*) iFSS_O(p),tau_O(1:3,p),h_num(1:4,p)
  enddo
  do q=1,new_nsp2
    write(3,*) iFSS_H(q),tau_H(1:3,q)
  enddo
  !
  !
  !Modified 20140901
